...
<head>
    ...
    <link rel="stylesheet" href="{{ public_path('assets/css/AdminLTE.min.css') }}">
    <link rel="stylesheet" href="{{ public_path('assets/css/style.css') }}">
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="{{ public_path('assets/css/_all-skins.min.css') }}">
    <!-- Google Font -->
    <link rel="stylesheet"
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ public_path('assets/js/jquery-ui.min.js') }}"></script>
<!-- Bootstrap 3.3.7 -->
<script src="{{ public_path('assets/js/bootstrap.min.js') }}"></script>
<!-- AdminLTE App -->
<script src="{{ public_path('assets/js/adminlte.min.js') }}"></script>
<!--CKEditor -->
<script src="{{ public_path('assets/ckeditor/ckeditor.js') }}"></script>
<!--My SCRIPT-->
